...
if(isset($_POST['btn-cad'])){
    ...
    if(empty($area)){
        echo '<div class="alert alert-danger" role="alert"><b>O campo Área é obrigátorio.</div>';
    }
    
    if(empty($data_legal)){
        echo '<div class="alert alert-danger" role="alert"><b><b>O campo Data Legal é obrigátorio.</div>';
    }
    
    if(empty($gravidade)){
        echo '<div class="alert alert-danger" role="alert"><b><b><b>O campo Gravidade é obrigátorio.</div>';
    }
    
    if(empty($urgencia)){
        echo '<div class="alert alert-danger" role="alert"><b><b><b><b>O campo Urgência é obrigátorio.</div>';
    }
    
    if(empty($tendencia)){
        echo '<div class="alert alert-danger" role="alert">O campo Tendência é obrigátorio.</div>';
    }
    
    if(empty($desc)){
        echo '<div class="alert alert-danger" role="alert">O campo Descrição é obrigátorio.</div>';
    }
...
<div class="container" id="agenda">
  ...
  <div class="form-row">
    ...
    <button type="submit" name="btn-cad" id="btn_buscar" class="btn btn-success">Salvar Alterações</button>
    <a href="../?p=tarefas" name="btn-cad" id="btn_buscar" class="btn btn-danger">Voltar para a lista de tarefas</a>
  </form>
  </div>
